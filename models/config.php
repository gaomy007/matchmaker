...
require_once("class.rprofile.php");
require_once("matchFuncs.php");
require_once("class.matchMachine.php");
require_once("class.archive.php");
require_once("class.geocoder.php");
require_once("class.cpm.php");
session_start();



define('MESSAGE_DELETE','1');
