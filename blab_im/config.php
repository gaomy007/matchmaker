...
$dbss['pass']='880717';                  // database password  (not used with sqlite)
$dbss['name']='blab_im';                  // Database name [mysql, postgre]. Note that the installation script cannot create a database for you!
